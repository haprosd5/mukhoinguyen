        ...
        <div class="col-lg-9 col-md-12 col-xs-12 pb-2">
            ...
            <div id="smartwizard" class="sw-main sw-theme-dots stepwizard p-4 border sw-theme-none">
                ...
                <ul class="nav nav-tabs step-anchor">
                    ...
                    <li class="nav-item active"><a href="#step-1" class="nav-link">Bước 1<br><small>Step 1</small></a>
                    </li>
                ...
                <div class="sw-container tab-content" style="min-height: 0px;">
                    ...
                    <div id="step-2" class="tab-pane step-content">
                        ...
                        <p><b>Bước 1</b>: Bạn hãy <img width="25"
                                                       ...
                                                       alt=""><b> Quét mã</b> dưới đây bằng ứng dụng <b>Momo</b>.<br>Hoặc
                            chọn mục <b>Chuyển tiền</b> <i class="fa fa-arrow-right"></i> <b>Chuyển tiền đến ví MoMo</b>
                            Nhập số điện thoại:
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="alert alert-warning fade in alert-dismissible show">
                                    ...
                                    <strong>Lưu ý!</strong> Số tiền phải là số lớn hơn 10,000 và chia hết cho 1,000.
                                </div>
                                <div class="alert alert-info"
                                     style="margin:10px 0 15px 0; /*padding:5px 5px 5px 15px;*/">
                                    <i class="fa fa-info-circle"></i> <a target="_blank"
                                                                         href="http://muh5z.com/huong-dan/nap-tien-bang-momo">Click
                                        xem hướng dẫn nạp qua Momo.</a>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="tel" class="form-control" id="confirmAmount" placeholder="Chọn để nhập"
                                           required="" maxlength="19">

                                    <div class="text-info pt-2">Xu thực nhận: <span id="coinReceive">0 </span></div>
                                    <div class="text-info pt-2">Lượt quay tặng thêm: <span id="turnReceive">0 </span>
                                    </div>
                                </div>
                ...
                <div class="btn-toolbar sw-toolbar sw-toolbar-bottom justify-content-end">
                    <div class="btn-group mr-2 sw-btn-group" role="group">
                        <button class="btn btn-warning sw-btn-next" type="button">Bước tiếp theo</button>
                    </div>
                </div>
            </div>
        </div>
